#ifndef GENERALIZED_REGION_GROWING_POINTS_CONNECTIVITY_3_H
#define GENERALIZED_REGION_GROWING_POINTS_CONNECTIVITY_3_H
    ...
    namespace Region_growing {
        namespace Region_growing_with_points {
            ...
            public:
                ...
                using Kd_tree_config    = Search_structures<Point_3, Element_with_properties>;
                using Fuzzy_circle      = typename Kd_tree_config::Fuzzy_circle;
                using Tree              = typename Kd_tree_config::Tree;

                Points_connectivity_3(const Input_range &input_range, const FT &radius) :
