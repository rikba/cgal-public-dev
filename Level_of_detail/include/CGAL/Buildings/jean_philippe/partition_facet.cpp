...
void Partition_Facet::get_circular_sequence_of_vertices(std::list<Partition_Vertex*> & V, bool orientation) const
{
	V.clear();
	...
	const CGAL_Plane & H_p = Universe::map_of_planes[this->p]->plane;
