...
{
public:
	Event_Vertex_Line(const int _intersectant, const int _intersected, const FT & _t_intersectant);
...
public:
	...
	bool is_queued;
	std::map<FT, std::list<Event_Vertex_Line*> >::iterator queue_iterator;
};
