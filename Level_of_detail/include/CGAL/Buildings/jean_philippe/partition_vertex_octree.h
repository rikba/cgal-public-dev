...
public:
	...
	void get_vertices_for_bounding_box_edge(const int i, const int j, std::list<Partition_Vertex *> & R) const;
...
private:
	...
	void set_query(std::vector<double> & query, const int i, const int j = -1) const;
