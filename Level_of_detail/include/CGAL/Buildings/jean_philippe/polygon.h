...
public:
	...
	inline void set_cell(Polygon_Cell* _cell) { cell = _cell; }

	inline Polygon_Cell* get_cell() { return cell; }
	...
	void split_unconstrained_vertex(Intersection_Line* I, Polygon_Vertex* v, const FT & t, const CGAL_Point_2 & V_t, Polygon_Vertex* & v1, Polygon_Vertex* & v2, Constraint & C);

	void remove_vertices_colliding_on_intersection_line(Intersection_Line* I, Polygon_Vertex* v, const FT & t, const CGAL_Point_2 & V_t, Polygon_Vertex* & vc_ts, CGAL_Vector_2 & u_ref);

	Polygon_Vertex* get_tied_vertex(Intersection_Line* I, Polygon_Vertex* v, const FT & t, const CGAL_Point_2 & V_t);

	Polygon_Vertex* get_tied_vertex(Intersection_Line* I, Polygon_Vertex* v, const FT & t, const CGAL_Point_2 & V_t, const CGAL_Vector_2 & u);

	void insert_unconstrained_vertex(Intersection_Line* I, Polygon_Vertex* v, const FT & t, Polygon_Vertex* vc_ts, Polygon_Vertex* v_c);

	void remove_vertices_colliding_in_dead_end(Polygon_Vertex* v1, Polygon_Vertex* v2, const FT & t, const CGAL_Point_2 & V_t);

	void redirect_constrained_vertex(Intersection_Line* I, Polygon_Vertex* v, const FT & t, const CGAL_Point_2 & V_t,
		Polygon_Vertex* & v_de, Polygon_Vertex* & v_ts, Constraint & C_ts);

	void redirect_constrained_vertex(Intersection_Line* I, Polygon_Vertex* v, Polygon_Edge* e, const FT & t, const CGAL_Point_2 & V_t,
	...
	void remove_intersectant_edge(Intersection_Line* I, Polygon_Vertex* v1, Polygon_Vertex* v2, const FT & t,
	...
	static Polygon* build_as_unconstrained_vertex_propagates(Polygon_Vertex* v, const FT & t,
	...
	static Polygon* build_as_constrained_vertex_propagates(Polygon_Vertex* v, const FT & t, 
		const int polygon_seed, Polygon_Vertex* vd_ts, Polygon_Vertex* v_ts,
		const Constraint & C_os, const Constraint & C_v_ts, Polygon_Vertex* & v_os);
	...
	static Polygon* build_as_edge_propagates(Polygon_Vertex* v1, Polygon_Vertex* v2, Polygon_Vertex* v1_ts, Polygon_Vertex* v2_ts, Polygon_Edge* e, const FT & t,
		const int seed, const Constraint & C_ts, Polygon_Vertex* & v1_os, Polygon_Vertex* & v2_os);

	void get_active_constrained_vertices(Intersection_Line* I_1, Intersection_Line* I_2, Polygon_Vertex* & v_1, Polygon_Vertex* & v_2);

	void shift_vertices(Polygon_Vertex* v1, Polygon_Vertex* v2, const CGAL_Point_2 & M, const FT & t);
...
private:
	...
	inline void delete_object(T* object, std::list<T*> & container, bool calls_destructor) {
		...
		if (calls_destructor) {
			...
			if (std::is_same<T*, Polygon_Vertex*>::value) {
				Polygon_Vertex* v = reinterpret_cast<Polygon_Vertex*>(object);
				v->set_as_member_of_polygon(nullptr);
			}
		}
		if (std::is_same<T*, Polygon_Vertex*>::value) {
			Polygon_Vertex* v = reinterpret_cast<Polygon_Vertex*>(object);
...
public:
	...
	//std::map<int, Polygon_Edge*> edges;
	int seed;
