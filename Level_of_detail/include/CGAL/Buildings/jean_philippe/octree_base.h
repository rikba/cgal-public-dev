...
class Octree_Base
{
	typedef Octree_Base_Vertex<Point_3, Inexact_Point_3> Octree_Vertex;
...
public:
	...
	void add(Octree_Vertex* v);

	void remove(Octree_Vertex* v, bool destroy);

	void get_all_vertices(std::list<Octree_Vertex*> & V) const;

private:
	Octree_Base<Point_3, Inexact_Point_3>* assign(Octree_Vertex* v) const;

public:
	void search(const Point_3 & M, const Inexact_Point_3 & hint_M, std::list<Octree_Vertex*> & R) const;

	void search(const std::vector<double> & dims, std::list<Octree_Vertex*> & R) const;

	static Octree_Base<Point_3, Inexact_Point_3>* remove(Octree_Base<Point_3, Inexact_Point_3>* T);
...
public:
	...
	std::list<Octree_Vertex*> vertices;
};



template <typename Point_3, typename Inexact_Point_3>
Octree_Base<Point_3, Inexact_Point_3>::Octree_Base(const std::vector<double> & dims)
...
template <typename Point_3, typename Inexact_Point_3>
Octree_Base<Point_3, Inexact_Point_3>::Octree_Base(const double _x_min, const double _x_max, const double _y_min, const double _y_max, 
	...
	parent(_parent)
{
	...
	vertices = std::list<Octree_Vertex*>();
}



template <typename Point_3, typename Inexact_Point_3>
Octree_Base<Point_3, Inexact_Point_3>::~Octree_Base()
{
	if (is_node) {
		...
		for (typename std::list<Octree_Vertex*>::iterator it_v = vertices.begin() ; it_v != vertices.end() ; it_v++) {
			delete (*it_v);
		}
	}
}
...
template <typename Point_3, typename Inexact_Point_3>
void Octree_Base<Point_3, Inexact_Point_3>::add(Octree_Vertex* v)
{
	double d_eps = 0.02;
	...
	if (is_node) {
		...
		if (!capacity_exceeded || (capacity_exceeded && (dz < d_eps || dy < d_eps || dx < d_eps))) {
			...
			children[0] = new Octree_Base<Point_3, Inexact_Point_3>(x_min, x_min + dx / 2, y_min, y_min + dy / 2, z_min, z_min + dz / 2, this);
			children[1] = new Octree_Base<Point_3, Inexact_Point_3>(x_min + dx / 2, x_max, y_min, y_min + dy / 2, z_min, z_min + dz / 2, this);
			children[2] = new Octree_Base<Point_3, Inexact_Point_3>(x_min, x_min + dx / 2, y_min + dy / 2, y_max, z_min, z_min + dz / 2, this);
			children[3] = new Octree_Base<Point_3, Inexact_Point_3>(x_min + dx / 2, x_max, y_min + dy / 2, y_max, z_min, z_min + dz / 2, this);
			children[4] = new Octree_Base<Point_3, Inexact_Point_3>(x_min, x_min + dx / 2, y_min, y_min + dy / 2, z_min + dz / 2, z_max, this);
			children[5] = new Octree_Base<Point_3, Inexact_Point_3>(x_min + dx / 2, x_max, y_min, y_min + dy / 2, z_min + dz / 2, z_max, this);
			children[6] = new Octree_Base<Point_3, Inexact_Point_3>(x_min, x_min + dx / 2, y_min + dy / 2, y_max, z_min + dz / 2, z_max, this);
			children[7] = new Octree_Base<Point_3, Inexact_Point_3>(x_min + dx / 2, x_max, y_min + dy / 2, y_max, z_min + dz / 2, z_max, this);

			// We divide the list of points and assign them to one of the subtrees according to their coordinates
			for (typename std::list<Octree_Vertex*>::iterator it_v = vertices.begin(); it_v != vertices.end(); it_v++) {
				Octree_Vertex* u = (*it_v);
				this->assign(u)->add(u);
			}
			vertices.clear();
...
template <typename Point_3, typename Inexact_Point_3>
void Octree_Base<Point_3, Inexact_Point_3>::remove(Octree_Vertex* v, bool destroy)
{
	...
	for (typename std::list<Octree_Vertex*>::iterator it_v = T->vertices.begin() ; it_v != T->vertices.end() ; it_v++) {
		if ((*it_v) == v) {
			if (destroy) delete v;
...
template <typename Point_3, typename Inexact_Point_3>
Octree_Base<Point_3, Inexact_Point_3>* Octree_Base<Point_3, Inexact_Point_3>::remove(Octree_Base<Point_3, Inexact_Point_3>* T)
{
	assert(T != nullptr);
...
template <typename Point_3, typename Inexact_Point_3>
void Octree_Base<Point_3, Inexact_Point_3>::get_all_vertices(std::list<Octree_Vertex*> & V) const
{
	if (is_node) {
...
template <typename Point_3, typename Inexact_Point_3>
bool Octree_Base<Point_3, Inexact_Point_3>::is_empty_leaf() const
{ 
...
template <typename Point_3, typename Inexact_Point_3>
bool Octree_Base<Point_3, Inexact_Point_3>::children_are_empty_leaves() const
{
...
template <typename Point_3, typename Inexact_Point_3>
Octree_Base<Point_3, Inexact_Point_3>* Octree_Base<Point_3, Inexact_Point_3>::assign(Octree_Vertex* v) const
{
	const Inexact_Point_3 & M = v->hint_M;
...
template <typename Point_3, typename Inexact_Point_3>
void Octree_Base<Point_3, Inexact_Point_3>::search(const Point_3 & M, const Inexact_Point_3 & hint_M, std::list<Octree_Vertex*> & R) const
{
	...
	if (((jin(x_min, a_min, x_max) || jin(x_min, a_max, x_max)) || (jin(a_min, x_min, a_max) || jin(a_min, x_max, a_max)))
		...
		if (is_node) {
			...
			for (typename std::list<Octree_Vertex *>::const_iterator it_v = vertices.begin(); it_v != vertices.end(); it_v++) {
				Octree_Vertex* v = (*it_v);
...
template <typename Point_3, typename Inexact_Point_3>
void Octree_Base<Point_3, Inexact_Point_3>::search(const std::vector<double> & dims, std::list<Octree_Vertex *> & R) const
{
